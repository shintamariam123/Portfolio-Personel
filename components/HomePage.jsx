    ...
    return (
        <>
                ...
                <div className='row container-fluid '>
                    ...
                    <div className="col-xl-2  col-lg-12 d-flex flex-column align-items-center justify-content-start ">
                        ...
                        <button className='btn btn-cv me-auto' style={{
                            ...
                            padding: '8px 15px',
                            borderRadius: '5px',
                            fontSize: '0.9rem', border: '2px solid #141952'
                        }} >
            ...
            <div className="qualifications container">
                <h2 style={{ color: "#aaa", fontWeight: '600', marginTop: '30px', textAlign: 'center' }} >Qualifications</h2>

                {/* Education */}
                <div className="qualification-item">
                    <div className='d-flex mb-2'>
                        <button className='edu-btn'><FaGraduationCap size={20} /></button>
                        <div className='d-flex flex-column'>
                            <h4 className='ms-3'>B.Tech in Computer Science </h4>
                            <p style={{ color: '#5057a6' }} className='ms-3'>KTU University | 2019 - 2023 | 8.56 cgpa</p>
                        </div>
                    </div>
                    <p>
                        My engineering background has equipped me with strong problem-solving and technical skills, which I leverage in my software development career to build efficient and scalable applications.
                    </p>
                </div>
                ...
                <div className="qualification-item">
                    <div className='d-flex mb-2'>
                        <button className='edu-btn'><IoMdRibbon size={20} /></button>
                        <div className='d-flex flex-column'>
                            <h4 className='ms-3'>Certifications & Training</h4>
                            <p style={{ color: '#5057a6' }} className='ms-3'>MERN Stack Certification - Luminar Technolab</p>
                        </div>

                    </div>
                    <p>
                        Completed a 6-month MERN Stack development program focused on enhancing coding skills, building full-stack applications, and mastering modern web technologies.
                    </p>
                </div>
                ...
                <div className="qualification-item">
                    <div className='d-flex mb-2'>
                        <button className='edu-btn'><MdWork size={20} /></button>
                        <div className='d-flex flex-column'>
                            <h4 className='ms-3'>Experience</h4>
                            <p style={{ color: '#5057a6' }} className='ms-3'>Frontend Developer Intern - MERN Stack</p>
                        </div>


                    </div>
                    <p>
                        Completed a 6-month Full Stack MERN internship, gaining hands-on experience in developing and optimizing web applications that are both responsive and dynamic using MERN Stack.
                    </p>
                </div>
            </div>
            ...
            <div className="container">
                <h2 style={{ color: "#aaa", fontWeight: '600', marginTop: '100px' }} className="text-center">SKILLS & EXPERTISE</h2>

                <div className="d-flex align-items-center gap-2 justify-content-around flex-wrap mt-5 mb-5">
                    ...
                    <div className="skills">
                        ...
                        <div className="skill-buttons p-1">
                            <button>HTML</button>
                            <button>CSS</button>
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <div>
                            <button type='submit' value="send" className='btn rounded-5 mt-4  px-4 py-3' disabled={!isFormComplete} style={{
                                backgroundColor: isFormComplete ? '#141952' : 'black',
